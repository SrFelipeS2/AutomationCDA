...
public class ProveedorView extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(pnlReporte, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public void obtenerProveedores(){
        ...
        try{
            LinkedList<Proveedor> list = controller.obtenerProveedores();
            ...
            if(list != null){
                ...
                for( Proveedor proveedor : list){
                    String data = "(" + proveedor.getNit() + ") - " + proveedor.getRazonSocial();
                    model.add(index, data);
                    index++;
                }

                lstProveedor.setModel(model);
            }
            
        }catch(SQLException e){
            JOptionPane.showMessageDialog(this, "Ocurrio un error en la base de datos", "Gestión proveedores", JOptionPane.ERROR_MESSAGE);
        }        
    }
    ...
    public void generarReporte(){
        ...
        try{
            LinkedList<ReporteProveedor> list = controller.obtenerReporte();
    ...
    public void generarReporteListadoProducto(){
        ...
        try{
            LinkedList<ReporteListadoProducto> list = controller.obtenerListadoProducto();
    ...
    private javax.swing.JList<String> lstProveedor;
