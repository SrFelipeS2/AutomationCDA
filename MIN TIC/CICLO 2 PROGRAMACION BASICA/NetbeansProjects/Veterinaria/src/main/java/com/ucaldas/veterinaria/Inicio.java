...
public class Inicio {
    ...
    public static void main(String[] args){
        ...
        mascota.setCode(1);
        mascota.setHealthStatus("Bien");
        System.out.println(mascota.getFullPet());
        
        
        System.out.println( mascota.getFullPet() );
        
        Pet mascota5 = new Pet("Sasha","Blanco, Cafe, Negro",123,2013,"Estable");
        ...
        Pet mascota3 = new Pet("Manchas","Amarillo, Negro", 123, 2022, "Bien");
        
        mascota3.setName("BocaNegra");
        System.out.println( mascota3.getFullPet() );
        
        Pet mascota4 = new Pet("Muñeca", "Delicado");
        ...
        sasha.setHealthStatus("Bien");
        sasha.setBornYear(2013);
        
        System.out.println( sasha.getFullPet() );
        
        Cat gatoNegro = new Cat("Gato negro","Blanco", 456, 2015, "Delicado");
